...
//        setLayout(null);
        ...
        ButtonGroup groupaccount = new ButtonGroup();     // choose one button only  
        groupaccount.add(r1);
        groupaccount.add(r2);
        groupaccount.add(r3);
        groupaccount.add(r4);
        ...
        c3 = new JCheckBox("Mobie Banking");
        ...
        getContentPane().setBackground(Color.WHITE);   //changing frame color 
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){
            ...
            String facility = "";
            if(c1.isSelected()){
                facility = facility + " Atm Card";   // muliple option selection and cancat all of these
            ...
            try {
                if (accountType.equals("")){
                    ...
                    Conn conn = new Conn();  //connect with database 
